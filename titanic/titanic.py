...
train, test = get_full_data(train_data, test_data)
...
def get_precision(y_real, y_predict):
    total = y_real.shape[0]
    real = y_real.reshape(-1, 1)
    predict = y_predict.reshape(-1, 1)
    correct = np.sum(real == predict)
...
#pdb.set_trace()
print get_precision(y_train, et_oof_train)
rf_oof_train, rf_oof_test = get_oof(rf,x_train, y_train, x_test) # Random Forest
print get_precision(y_train, rf_oof_train)
ada_oof_train, ada_oof_test = get_oof(ada, x_train, y_train, x_test) # AdaBoost 
print get_precision(y_train, ada_oof_train)
gb_oof_train, gb_oof_test = get_oof(gb,x_train, y_train, x_test) # Gradient Boost
print get_precision(y_train, gb_oof_train)
svc_oof_train, svc_oof_test = get_oof(svc,x_train, y_train, x_test) # Support Vector Classifier
print get_precision(y_train, svc_oof_train)
...
#py.plot(fig,filename='scatter2010-1.html')
...
#fig = go.Figure(data=data, layout=layout)
#py.plot(fig,filename='scatter2010-2.html')
...
#fig = go.Figure(data=data, layout=layout)
#py.plot(fig,filename='scatter2010-3.html')
...
#fig = go.Figure(data=data, layout=layout)
#py.plot(fig,filename='scatter2010-4.html')
...
#fig = go.Figure(data=data, layout=layout)
#py.plot(fig, filename='bar-direct-labels.html')
...
#pdb.set_trace()
print get_precision(y_train, prediction_train)
